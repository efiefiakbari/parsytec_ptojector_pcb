...
///////////////configuration of TIM1/////////////////
	...
	int compare_value1=period_value*0.45; // defining the duty cycle of pwm/////////////  1  ///////  D C =0.4    1A /// D C =0.38 0.9A   0.3+0.9=1.2 //// 0.5
	...
	int compare_value6=period_value*0.45; // defining the duty cycle of pwm/////////////  6  ///////  D C =---    1A /// D C =0.45 0.9A		4.8+0.9=5.7////0.55
	int compare_value7=period_value*0.45; // defining the duty cycle of pwm //
	int compare_value8=period_value*0.45; // defining the duty cycle of pwm //
	...
	int compare_value12=period_value*0.4; // defining the duty cycle of pwm //////////////////////0.4
